...
echo "  --skip-swagger   Skip swagger endpoint indexing"
echo "  --skip-protos    Skip proto definition indexing"
echo "  --skip-source    Skip Go source indexing (largest/slowest part)"
echo ""
